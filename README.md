...
![WhirlyTask automation flow](assets/whirlytask-automation-flow.svg)
...
Download it [here]([https://semver.org/spec/v2.0.0.html](https://github.com/Kais80r/WhirlyTask-Download/releases)).
...
- Sending Discord notifications with live values.
- Recovering from popups, errors, focus changes, or missing states.
- Combining normal automation steps with background watchers.
